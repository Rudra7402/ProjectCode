...
// Agar A true hai → B return karo
// Agar A false hai → A return karo


//THIS IS HOW HANDLESUBMIT WORKS:-
// function handleSubmit(userFunction) {
//     return function(event) {
//         event.preventDefault();

//         const data = getFormData(); // saare inputs ka data

//         const isValid = validate(data); // Zod validation

//         if (isValid) {
//             userFunction(data); // 👈 yaha call ho raha hai tera function
//         }
//     }
// }